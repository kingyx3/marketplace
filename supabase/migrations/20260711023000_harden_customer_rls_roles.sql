-- Make customer-facing policies explicit about the authenticated role and add
-- WITH CHECK clauses so ownership cannot be changed through an allowed update.
