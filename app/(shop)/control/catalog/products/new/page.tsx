...
import { TcgplayerCatalogImport } from "@/app/(shop)/control/_components/tcgplayer-catalog-import-complete";
      ...
      <section className="grid gap-5 rounded-xl border border-zinc-200 bg-white p-5 shadow-sm sm:p-6">
        <div>
          ...
          <h2 className="mt-1 text-xl font-semibold text-zinc-950">
            Build a product manually
          </h2>
          <p className="mt-1 text-sm text-zinc-600">
            Use the standard hierarchy form when TCGplayer does not have the
            product or its public storefront data is unavailable.
          </p>
        </div>
        <ProductIntakeForm
          categories={activeCategories}
