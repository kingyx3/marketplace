...
export default function PrivacyPage() {
  ...
  return (
    <PolicyPage
      title="Privacy Policy"
      summary={`${operator} explains here how personal data is handled when you browse, sign in, buy, join a waitlist, or contact support.`}
    >
      ...
      <PolicySection title="Why we use personal data">
        <p>
          We use data to authenticate accounts, fulfil orders and preorders, apply eligible deals,
          prevent fraud, deliver notifications, provide support, meet accounting and legal duties,
          secure the service, and diagnose reliability problems. Marketing messages are sent only
          where the required choice or permission has been recorded.
        </p>
      </PolicySection>
