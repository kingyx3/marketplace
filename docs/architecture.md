...
Browser ──▶ Vercel (Next.js 16, App Router)
              ...
              ├─ /api/webhooks/hitpay  (signature-verified, idempotent)
...
- CI resolves provider values, reconciles hosted auth and HitPay, syncs Vercel environment values, applies migrations, deploys, and runs readiness checks.
