...
| `HITPAY_API_URL`                                  | Runtime | Yes                             | No     | HitPay API base URL                                                                      |
| `HITPAY_PAYMENT_METHODS`                          | Runtime | Yes                             | No     | Comma-separated HitPay online payment method codes                                       |
...
| `HITPAY_WEBHOOK_ID`                               | Deploy  | No                              | No     | Registered HitPay webhook id                                                             |
| `HITPAY_WEBHOOK_ENABLED_EVENTS`                   | Deploy  | No                              | No     | HitPay webhook event override                                                            |
